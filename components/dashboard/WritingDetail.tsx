...
export default function WritingDetail({ data }: WritingDetailProps) {
  const { t } = useLanguage();
  ...
  return (
    <div className="space-y-6 rounded-xl border border-gray-200 bg-white p-5">
      ...
      {data.weaknesses.length > 0 && (
        <div>
          <h3 className="mb-2 text-sm font-semibold text-gray-700">{t("dashboard_recurring_weaknesses")}</h3>
