...
import OnboardingFreeProModal from "@/components/OnboardingFreeProModal";
...
export default function WritingDetailClient({ submission, feedback, isPro, isOnboarding }: Props) {
  const { t } = useLanguage();
  const fb = feedback.feedback_json;
  const [showFreePro, setShowFreePro] = useState(false);
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const driverObj = driver({
        ...
        doneBtnText: t("onboarding_feedback_done_btn"),
        onNextClick: () => {
        ...
        steps: [
          {
            element: "#feedback-band",
            popover: {
              title: t("onboarding_feedback_band_title"),
              description: t("onboarding_feedback_band_body"),
              side: "bottom",
              align: "start",
            },
          },
          {
            element: "#feedback-sw",
            popover: {
              title: t("onboarding_feedback_sw_title"),
              description: t("onboarding_feedback_sw_body"),
              side: "bottom",
              align: "start",
            },
          },
          {
            element: "#feedback-corrections",
            popover: {
              title: t("onboarding_feedback_corrections_title"),
              description: t("onboarding_feedback_corrections_body"),
              side: "top",
              align: "start",
            },
          },
          {
            element: "#feedback-improvements",
            popover: {
              title: t("onboarding_feedback_improvements_title"),
              description: t("onboarding_feedback_improvements_body"),
              side: "top",
              align: "start",
            },
          },
  ...
  return (
    <>
      {showFreePro && <OnboardingFreeProModal onClose={() => setShowFreePro(false)} />}
      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-8">
        ...
        {/* Band scores */}
        <div id="feedback-band" className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
        ...
        <div id="feedback-sw" className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <div id="feedback-corrections" className="mt-4 rounded-xl border border-gray-200 bg-white p-5">
        ...
        {/* Top 3 improvements */}
        <div id="feedback-improvements" className="mt-4 rounded-xl border border-blue-200 bg-blue-50 p-5">
